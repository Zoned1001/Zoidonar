    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        ref.child("Events").child(mdataDate.get(i)).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                holder.itemEventName.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String baseDate = holder.itemEventDate.getText().toString();

                        //Toast.makeText(c, baseDate, Toast.LENGTH_SHORT).show();

                        Intent i = new Intent(v.getContext(), archiveData.class);
                        i.putExtra("baseDate", baseDate);
